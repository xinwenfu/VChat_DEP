...
##
# File path: /usr/share/metasploit-framework/modules/exploit/windows/VChat/TRUN_UDEP.rb
##
# This module exploits the TRUN command of vulnerable chat server to showcase DEP protections on Windows
##
